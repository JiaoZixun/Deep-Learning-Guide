...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            ...
            self.load_state_dict(torch.load("./init_checkpoints/segformer_b0_backbone_weights.pth"), strict=False)
...
class mit_b1(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./init_checkpoints/segformer_b1_backbone_weights.pth"), strict=False)
...
class mit_b2(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./init_checkpoints/segformer_b2_backbone_weights.pth"), strict=False)
...
class mit_b3(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./init_checkpoints/segformer_b3_backbone_weights.pth"), strict=False)
...
class mit_b4(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./init_checkpoints/segformer_b4_backbone_weights.pth"), strict=False)
...
class mit_b5(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./init_checkpoints/segformer_b5_backbone_weights.pth"), strict=False)


class segformer_b0():
    def __init__(self, pretrained = False):
        super(segformer_b0, self).__init__()
        self.transformer = mit_b0(pretrained)
    def forward(self, x):
...
class segformer_b1():
    def __init__(self, pretrained = False):
        ...
        self.transformer = mit_b1(pretrained)
    def forward(self, x):
        return self.transformer.forward(x)
    def __call__(self, x):
        # 直接调用 forward 方法
...
class segformer_b2():
    def __init__(self, pretrained = False):
        ...
        self.transformer = mit_b2(pretrained)
    def forward(self, x):
        return self.transformer.forward(x)
    def __call__(self, x):
        # 直接调用 forward 方法
...
class segformer_b3():
    def __init__(self, pretrained = False):
        ...
        self.transformer = mit_b3(pretrained)
    def forward(self, x):
        return self.transformer.forward(x)
    def __call__(self, x):
        # 直接调用 forward 方法
...
class segformer_b4():
    def __init__(self, pretrained = False):
        ...
        self.transformer = mit_b4(pretrained)
    def forward(self, x):
        return self.transformer.forward(x)
    def __call__(self, x):
        # 直接调用 forward 方法
...
class segformer_b5():
    def __init__(self, pretrained = False):
        super(segformer_b5, self).__init__()
        self.transformer = mit_b5(pretrained)
    def forward(self, x):
        return self.transformer.forward(x)
    def __call__(self, x):
        # 直接调用 forward 方法
